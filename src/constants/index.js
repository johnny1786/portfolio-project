...
const projects = [
  {
    name: "Next Tutorial",
    description:
      "A web-based platform enabling users to view the status of their invoice transactions.",
    tags: [
      {
        name: "Nextjs",
  ...
  },
  {
    ...
    description:
      "Web application that enables users to track their expenses and manage money",
    tags: [
      {
        name: "react",
        color: "blue-text-gradient",
